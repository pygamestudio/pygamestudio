...
class ObjectEllipse:
    def __init__(self, game_manager, object_data=None):
        ...
        self.name = self._object_data.get('name', 'Ellipse')
        self.type = self._object_data.get('type', OBJECT_ELLIPSE)
        ...
        self.x = self._object_data.get('x', 0)
        self.y = self._object_data.get('y', 0)
        self.pos = self._object_data.get('pos', (0, 0))
        self.width = self._object_data.get('width', 100)
        self.height = self._object_data.get('height', 50)
        self.size = self._object_data.get('size', (100, 50))
