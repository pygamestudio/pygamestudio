...
class AssetSortFilterProxyModel(QSortFilterProxyModel):
    ...
    def lessThan(self, source_left, source_right):
        ...
        sort_type = self.__tree_view.get_sort_type()
    ...
    #     return False
        ...
        # if self.__pattern.match(item_name).hasMatch():
        #     print(111)
        #     self.__tree_view.setExpanded(source_index, True)
        #     print(self.__tree_view.isExpanded(source_index))
        #     return True
        # else:
        #     return False

        # return self.__pattern.match(item_name).hasMatch()